public class Data
{
    ...
    public Data getDiaSeguinte () // não altera o this
    {
        ...
        {} // sei que nao vai dar erro pq crie a nova data a partir duma velha que, quando foi criada, ja foi validada
        retorno.avanceUmDia();
        return retorno;
    }
...
// serve para comparar this e obj
// this, certamente, é Data
// this nunca é null
@Override
public boolean equals (Object obj)
{
    ...
    Data dat = (Data)obj;
    if (dat.dia!=this.dia) return false;
    if (dat.mes!=this.mes) return false;
    if (dat.ano!=this.ano) return false;
    return true;
}
